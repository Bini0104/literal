...
public class Application01 {
    public static void main(String[] args) {
        ...
        /* 수업 목표 . 변수의 사용목적에 대해 이해 할 수 있다.
        * 필기.
        * 변수의 사용목적
        * 1. 값에 의미를 부여하기 위한 목적(의미 전달이 쉬워야 코드를 읽기 쉬워지고, 협업 및 유지보수에 유리하기 때문이다.
        * 2. 한 번 저장해둔 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때보다 간편하게 변경 할 수 있다.
        * 3. 시간에 따라 변하는 값을 저장하고 사용할 수있다.(변하는 값을 저장하기 위한 공간이다.*/

        //1. 값에 의미를 부여하기위한 목적
        System.out.println("=====값에 의미를 부여하기 위한 테스트=====");
        ...
        // 시간에 따라 변경되는 값을 저장하고 사용할 수있다.
        System.out.println("======변수에 저장되 값 변경 테스트=====");
        // 변수는 하나의 값을 저장하고 사용하기ㅣ 위한 공간이기 보다, 변하는 값을 저장하기 위한 공간이다.
        int sum = 0;
        sum = sum + 10;
        System.out.println("sum에 10을 더하면 현재 sum 의 값은?" + sum);
        ...
        int count = 0;
        count = count +1;
        System.out.println("count 에 1을 더하면 현재 count 의 값은?" + count);
