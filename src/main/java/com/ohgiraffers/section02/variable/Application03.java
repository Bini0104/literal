...
public class Application03 {
    ...
    * */
        ...
        * 1-5.특수기호는 '_'와 '$'만 사용이 가능하다. (공백을 사용할 수 없다.)
        *
...
//        int sh@rp = 20;
        ...
        int asjdlfjasldjflaksdjflaksjfjeolkndfsjdhfkjahsdjfh;

        /* 목차 2-2. 변수명이 합성어로 이루어진 경우 첫단어는 소문자, 두 번째 시작단어는 대문자로 시작한다.*/
        int maxAge = 20;
        int minAge = 10;
        ...
        /* 목차 2-5. 변수 안에 저장된 값이 어떤의미를 가지는지 명확하게 표현하도록한다.*/
        ...
        /*목차 2-7. 명사형으로 작성할 수있도록 한다.*/
        String goHome; // 가능하지만 가급적 명사형으로 짓는다.
        String Home;

        /*목차 2-8. boolean형은 의문문으로 가급적 긍정형으로 네이밍한다.*/
