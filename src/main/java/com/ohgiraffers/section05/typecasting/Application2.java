...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 1-3. 문자형을 int 미만 크기의 변숭 저장 할 때 강제 형변환이 필요하다.
...
//        int inum = lnum;      // 데이터 손실 가능성을 컴파일러가 알려준다.(에러남)
        ...
        /* 목차 1-2. 실수를 정수로 변경 시 형변환이 필요하다.*/
        float fnum2 = 4.0f;
//        long lnum2 = fnum2; // 소수점 자리 이하 데이터 손실 가능성
        long lnum2 = (long) fnum2;

        /* 목차 1-3. 문자형을 int 미만 크기의 변수에 저장할 때 강제 형변환이 필요하다.*/
        char ch ='a';
        byte bnum2 = (byte) ch;     // char 자료형 보다 작은 크기이니 강제 형변환을 해야한다.
