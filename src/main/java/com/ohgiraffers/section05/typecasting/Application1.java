...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*필기. 작은 자료형에서 큰 자료형으로 공간만 옭기는 경우
...
//        int result = num1 + num2; // 자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int 형 변수에 값을 담을 수 없다.
        long result = num1 + num2;  // int + long은 서로 다른 자료형이라 데이터 손실이 발생하지 않는 int -> long 변환을 자동수행 후 연산한다.

        System.out.println(result);

        /* 목차 1-1-2. 실수끼리의 자동 형변환*/
        float fnum = 4.0f;
        double dnum = fnum;
